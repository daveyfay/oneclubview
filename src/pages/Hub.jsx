...
function HubInner({ user, profile, onRefresh, onLogout }) {
  ...
  return (
    <div className="anim-fade" style={{ background: "var(--color-warm)", minHeight: "100vh" }} onTouchStart={ptrTouchStart} onTouchMove={ptrTouchMove} onTouchEnd={ptrTouchEnd}>
      ...
      {showNotifs && <div style={{ position: "fixed", top: 52, right: 12, left: 12, zIndex: 61, background: "#fff", borderRadius: 16, border: "1px solid var(--color-border)", boxShadow: "0 8px 30px rgba(0,0,0,.12)", padding: 8, maxHeight: "60vh", overflowY: "auto", maxWidth: 400, marginLeft: "auto" }}>
      ...
      {showFab && <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 71, background: "#fff", borderRadius: "20px 20px 0 0", padding: "20px 20px calc(20px + env(safe-area-inset-bottom, 0px))", maxHeight: "75vh", overflowY: "auto", boxShadow: "0 -8px 40px rgba(0,0,0,.15)", animation: "slideUp .25s ease" }}>
        ...
        {isAdmin && <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 16 }}>
          <div onClick={() => { setShowFab(false); setShowAddEv(true) }} style={{ padding: "14px 8px", borderRadius: 14, border: "2px solid var(--color-border)", background: "#fff", cursor: "pointer", textAlign: "center", transition: "all .15s" }} onMouseEnter={e => { e.currentTarget.style.borderColor = "var(--color-primary)"; e.currentTarget.style.background = "var(--color-primary-bg)" }} onMouseLeave={e => { e.currentTarget.style.borderColor = "var(--color-border)"; e.currentTarget.style.background = "#fff" }}>
          ...
          <div onClick={() => { setShowFab(false); onRefresh("clubs") }} style={{ padding: "14px 8px", borderRadius: 14, border: "2px solid var(--color-border)", background: "#fff", cursor: "pointer", textAlign: "center", transition: "all .15s" }} onMouseEnter={e => { e.currentTarget.style.borderColor = "var(--color-primary)"; e.currentTarget.style.background = "var(--color-primary-bg)" }} onMouseLeave={e => { e.currentTarget.style.borderColor = "var(--color-border)"; e.currentTarget.style.background = "#fff" }}>
          ...
          <div onClick={() => { setShowFab(false); setShowAddPlaydate(true) }} style={{ padding: "14px 8px", borderRadius: 14, border: "2px solid var(--color-border)", background: "#fff", cursor: "pointer", textAlign: "center", transition: "all .15s" }} onMouseEnter={e => { e.currentTarget.style.borderColor = "var(--color-primary)"; e.currentTarget.style.background = "var(--color-primary-bg)" }} onMouseLeave={e => { e.currentTarget.style.borderColor = "var(--color-border)"; e.currentTarget.style.background = "#fff" }}>
          ...
          <div onClick={() => { setShowFab(false); setShowAddActivity(true) }} style={{ padding: "14px 8px", borderRadius: 14, border: "2px solid var(--color-border)", background: "#fff", cursor: "pointer", textAlign: "center", transition: "all .15s" }} onMouseEnter={e => { e.currentTarget.style.borderColor = "var(--color-primary)"; e.currentTarget.style.background = "var(--color-primary-bg)" }} onMouseLeave={e => { e.currentTarget.style.borderColor = "var(--color-border)"; e.currentTarget.style.background = "#fff" }}>
