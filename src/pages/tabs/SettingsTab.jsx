    ...
    <ErrorBoundary label="Settings">
      <>
        ...
        <div style={{ position: "fixed", top: 56, right: 12, zIndex: 61, background: "var(--color-card)", borderRadius: 16, border: "1px solid var(--color-border)", boxShadow: "0 8px 30px rgba(0,0,0,.12)", padding: 8, minWidth: 200 }}>
          ...
          : profile?.subscription_status !== "active" && <button onClick={() => { onClose(); startCheckout("standard") }} style={{ width: "100%", padding: "10px 14px", border: "none", background: "none", cursor: "pointer", fontSize: 13, fontWeight: 600, color: "var(--color-accent)", fontFamily: "var(--font-sans)", textAlign: "left", borderRadius: 8, display: "flex", alignItems: "center", gap: 8 }}>{"\u2B50"} Subscribe {"\u2014"} {"\u20AC"}4.99/mo</button>}
